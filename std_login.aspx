<%@ Page Language="C#" AutoEventWireup="true" CodeFile="std_login.aspx.cs" Inherits="std_login" %>
...
<body>
    <form id="form1" runat="server">
        <div class="main">
            ...
            <label for="myInput">Roll-number:<br />
                </label>
                &nbsp;<asp:TextBox runat="server" ID="MyTextBox" Height="33px" Width="229px"  placeholder="Roll no. (e.g. i21-1234)" OnTextChanged="MyTextBox_TextChanged"></asp:TextBox>
           <br><p>Password:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="image-text">Flex-Student</div>
                </div>
        </div>
